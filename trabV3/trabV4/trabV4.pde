...
public void draw() {
  ...
  case 4:
    ...
    // salario pais selecionado
    float mg = map(paisG.primaryMaleValue, 0, width, 0, width);

    fill(13, 39, 255, 200);
    rect(100, 280, mg, 20, 12);
    fill(255);
    text(paisG.primaryMaleValue, 100, 295);

    // salario medio
    float ng = map(paisG.secondaryMaleValue, 0, width, 0, width);
    fill(12, 94, 232, 150);
    rect(100, 380, ng, 20, 12);
    fill(255);
    text(paisG.secondaryMaleValue, 100, 395);

    // salario mais alto
    float og = map(paisG.tertiaryMaleValue, 0, width, 0, width);
    fill(0, 162, 255, 100);
    rect(100, 480, og+5, 20, 12);
    fill(255);
    text(paisG.tertiaryMaleValue, 100, 495);     



    // salario pais selecionado
    float qg = map(paisG.primaryFemaleValue, 0, width, 0, width);

    fill(318, 36, 15, 200);
    rect(1250, 280, -qg, 20, 12);
    fill(255);
    text(paisG.primaryFemaleValue, 1190, 295);

    // salario medio
    float rg = map(paisG.secondaryFemaleValue, 0, width, 0, width);
    fill(331, 67, 25, 150);
    rect(1250, 380, -rg, 20, 12);
    fill(255);
    text(paisG.secondaryFemaleValue, 1190, 395);

    // salario mais alto
    float sg = map(paisG.tertiaryFemaleValue, 0, width, 0, width);
    fill(343, 81, 45, 100);
    rect(1250, 480, -sg, 20, 12);
    fill(255);
    text(paisG.tertiaryFemaleValue, 1190, 495);
    ...
    fill(40, 50, 60, 200);
    noStroke();
    text(paisG.primaryMale, 200, 660);
    fill(40, 50, 60, 200);
    text(paisG.secondaryMale, 200, 710);
    fill(40, 50, 60, 200);
    text(paisG.tertiaryMale, 200, 760);

    fill(40, 50, 60, 200);
    text(paisG.primaryFemale, 200, 810);
    fill(40, 50, 60, 200);
    text(paisG.secondaryFemale, 200, 860);
    fill(40, 50, 60, 200);
    text(paisG.tertiaryFemale, 200, 910);
  ...
  fill(0);
  text("Seccao Geral: " + seccaogeral, 600, 30);
}

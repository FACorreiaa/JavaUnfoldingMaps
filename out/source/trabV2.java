...
public class trabV2 extends PApplet {
...
public void setup() {
  ...
  map.zoomToLevel(4);
    ...
    // instrucao para suavisar graficos em todo o programa
...
class Pais  { 
  ...
  public void desenhaRato() {    
    fill(0);
    text("Coordenadas: " + mouseX + " " + mouseY, 650,10); 
  }
  
  public void desenhaEdu(int x, int y) {
     text(nome+"\n", x+150, y+150);
  }
}
  public void settings() {  size(1400, 1080, P2D);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "trabV2" };
    if (passedArgs != null) {
